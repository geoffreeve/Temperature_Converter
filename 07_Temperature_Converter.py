from tkinter import *
from functools import partial  # To prevent unwanted wnidows
import random
...
class Converter:
    def __init__(self):
        ...
        # Converter Frame
        self.converter_frame = Frame(bg=background, pady=10)
        self.converter_frame.grid()

        # Temperature Converter heading (row 0)
        self.temp_heading_label = Label(self.converter_frame, text="Temperature Converter",
                                        font="Arial 16 bold", bg=background, pady=10, padx=10)
        ...
        self.temp_instructions_label = Label(self.converter_frame,
                                             ...
                                             justify=LEFT, bg=background, padx=10, pady=10)
        ...
        self.to_c_button = Button(self.conversion_buttons_frame, text="To Centigrade",
                                  bg="light green", font="Arial 10 bold", pady=10, padx=10,
                                  command=lambda: self.temp_convert(-459))
        self.to_c_button.grid(row=0, column=0)

        self.to_f_button = Button(self.conversion_buttons_frame, text="To Fahrenheit",
                                  bg="hot pink", font="Arial 10 bold", pady=10, padx=10,
                                  command=lambda: self.temp_convert(-273))
        self.to_f_button.grid(row=0, column=1)

        # Answer label (Row 4)
        self.converted_label = Label(self.converter_frame, font="Arial 10 bold",
                                     fg="purple", bg=background, pady=10,
